...
class Fee:
    ...
    def inputFeeDetails(self):
        ...
        if difference == 1:
            ...
            amount = self.amount
            fine = ((0.1*amount) + amount)* difference
            totalfee = (amount) + fine
            print("Amount Payable for {} months + {} month is:{}".format(difference,difference+1, totalfee))
